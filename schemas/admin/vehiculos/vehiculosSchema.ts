...
export const postVehiculoSchema = z.object({
    ...
    ValorVehiculo: z.coerce.number().min(0, "Debe ser un número mayor o igual a 0"),
    ValorFactura: z.coerce.number().min(0, "Debe ser un número mayor o igual a 0"),
    ...
    Salvamento: z.coerce.number().min(0, "Debe ser un número mayor o igual a 0"),
    NoMotor: z.string(),
    Placas: z.string(),
    VIN: z.string(),
});
