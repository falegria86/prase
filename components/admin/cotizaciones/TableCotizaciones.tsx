...
export const TableCotizaciones = ({ cotizaciones, tiposVehiculo, usosVehiculo }: Props) => {
    ...
    const obtenerNombreTipoVehiculo = (tipoId: number) => {
        return tiposVehiculo.find(tipo => tipo.TipoID === tipoId)?.Nombre || 'No especificado';
    };

    const obtenerNombreUsoVehiculo = (usoId: number) => {
        return usosVehiculo.find(uso => uso.UsoID === usoId)?.Nombre || 'No especificado';
    };
