...
import { iApplication, iGetApplicationGroup, iPatchApplicationGroup } from '@/interfaces/SeguridadInterface'
...
export default function ResumenPermisosAplicaciones({ initialGroups }: Props) {
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction onClick={() => handleDelete(group.id)}>Continuar</AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
                </AlertDialog>
              </td>
